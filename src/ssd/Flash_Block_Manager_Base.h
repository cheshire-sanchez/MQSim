...
#define All_VALID_PAGE 0x0000000000000000ULL
	...
	*/
	...
	public:
		...
		flash_block_ID_type Get_the_coldest_block_id(const NVM::FlashMemory::Physical_Page_Address& plane_address);
		flash_plane_ID_type Get_the_coldest_plane_id(const NVM::FlashMemory::Physical_Page_Address& plane_address);
